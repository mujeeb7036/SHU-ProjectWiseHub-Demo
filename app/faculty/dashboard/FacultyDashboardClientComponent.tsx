...
export default function FacultyDashboardClientComponent() {
  ...
  useEffect(() => {
    document.title = "Faculty Dashboard - SHU ProjectWise Hub"
  }, [])
  ...
  return (
    <>
      <Head>
        <title>Faculty Dashboard - SHU ProjectWise Hub</title>
        <meta name="description" content="Faculty research portal for discovering and reviewing student projects" />
      </Head>
